locals {
  ...
  definitions = {
    ...
    validator_expressions = {
      ...
      aws_organizations_policy_content_json            = "can-jsondecode"
    ...
    validator_error_messages = {
      ...
      aws_organizations_policy_content_json            = "Each policy.content must be valid JSON. Use jsonencode(...) when building policy bodies in HCL."
